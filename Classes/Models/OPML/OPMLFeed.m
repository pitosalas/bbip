...
- (id)initWithTitle:(NSString *)aTitle xmlURL:(NSString *)anXmlURL htmlURL:(NSString *)anHtmlURL readArticleKeys:(NSArray *)aReadArticleKeys handlingType:(NSNumber *)aHandlingType {
	if (self = [super init]) {
		title			= [aTitle copy];
